...
utils::globalVariables(c(
  ".", "2.5 %", "97.5 %", "coef", "vcov", "evt", "time2evt", "tmp_evt_dt",
  "tmp_end_dt", "tmp_idx_dt", "time", "level", "n", "stat", "xtabs", "variable",
  "data", "pval", "se", "test", "row_id", "row_number", "type", "rowname", "first_evt_dt",
